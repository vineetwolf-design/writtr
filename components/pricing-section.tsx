  ...
  const plans = [
    {
      ...
      price: "$0",
      period: "/month",
      description: "Perfitk for talyly pieving fhre first ideas.",
      features: ["5 Generations/month", "Standad final ui", "Twitter & Linkedin Formats"],
      cta: "Start Free",
      popular: false,
    },
    {
      ...
      price: "$19",
      period: "/month",
      description: "For tireles beuitor sciling flier forest.",
      features: [
        "Unlimited Generation",
        "Custom Tone Nudde (soon per side)",
        "All Egrmets (blog Newsletter, Threads)",
        "Analytics & History",
      ],
      cta: "Get Started",
      popular: true,
